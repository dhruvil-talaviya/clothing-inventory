...
const StaffDashboard = () => {
    ...
    const handleCheckout = async (e)=>{
        ...
        try {
            ...
            setCustomerForm({name:'',phone:'',email:'',homeAddress:'',city:''}); setSelectedPaymentMethod('cash');
            fetchData();
            // Open invoice modal so staff can download PDF or email manually
                    ...
                    <div className="bg-[#0F172A] border border-slate-700 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
                        ...
                        <form onSubmit={handleCheckout} className="p-5 space-y-4 overflow-y-auto ds max-h-[80vh]">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button type="submit" className="flex-[2] py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-black rounded-xl transition-all flex items-center justify-center gap-2 text-sm"><FiPrinter size={14}/> Complete Sale & Print Bill</button>
                            </div>
                        </form>
                    </div>
                </div>
